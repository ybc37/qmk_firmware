...
*/
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Tab/Num|  q  |  w  |  e  |  r  |  t  |  y  |  u  |  i  |  o  | PS | HOME | END |   \    |
  * |-----------------------------------------------------------------------------------------+
 ...
 [_FN2_LAYER] = KEYMAP(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(_DIRECT_LAYER), KC_TRNS, KC_TRNS
 ),
 ...
 [_DIRECT_LAYER] = KEYMAP(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, TG(_DIRECT_LAYER), KC_TRNS, KC_RCTL
),
